...
public class ProxyManifest {
    ...
    public static String getProxyPendingActivity(int index) {
        return String.format(Locale.CHINA, "app.viscount.loader.proxy.ProxyPendingActivity$P%d", index);
    }

    public static String getProxyActivity(int index) {
        return String.format(Locale.CHINA, "app.viscount.loader.proxy.ProxyActivity$P%d", index);
    }

    public static String TransparentProxyActivity(int index) {
        return String.format(Locale.CHINA, "app.viscount.loader.proxy.TransparentProxyActivity$P%d", index);
    }

    public static String getProxyService(int index) {
        return String.format(Locale.CHINA, "app.viscount.loader.proxy.ProxyService$P%d", index);
    }

    public static String getProxyJobService(int index) {
        return String.format(Locale.CHINA, "app.viscount.loader.proxy.ProxyJobService$P%d", index);
    }
