...
import app.viscount.loader.app.LauncherActivity;
...
import app.viscount.loader.core.GmsCore;
import app.viscount.loader.core.NativeCore;
import app.viscount.loader.core.env.BEnvironment;
import app.viscount.loader.core.system.DaemonService;
...
import app.viscount.loader.entity.pm.InstallResult;

import app.viscount.loader.fake.delegate.ContentProviderDelegate;
import app.viscount.loader.fake.frameworks.BActivityManager;
import app.viscount.loader.fake.frameworks.BJobManager;
import app.viscount.loader.fake.frameworks.BPackageManager;
import app.viscount.loader.fake.frameworks.BStorageManager;
import app.viscount.loader.fake.frameworks.BUserManager;

import app.viscount.loader.fake.hook.HookManager;
import app.viscount.loader.proxy.ProxyManifest;
import app.viscount.loader.utils.FileUtils;
import app.viscount.loader.utils.ShellUtils;
import app.viscount.loader.utils.Slog;
import app.viscount.loader.utils.SimpleCrashFix;
import app.viscount.loader.utils.compat.BuildCompat;
import app.viscount.loader.utils.compat.BundleCompat;

import app.viscount.loader.utils.provider.ProviderCall;
import app.viscount.loader.utils.StackTraceFilter;
import app.viscount.loader.utils.SocialMediaAppCrashPrevention;
import app.viscount.loader.utils.DexCrashPrevention;
import app.viscount.loader.utils.NativeCrashPrevention;
import app.viscount.loader.utils.CrashMonitor;
import app.viscount.loader.utils.StoragePermissionHelper;
import app.viscount.loader.utils.LogSender;
...
public class BlackBoxCore extends ClientConfiguration {
    ...
    public void closeCodeInit(){
        try {
            Class entry = Class.forName("app.viscount.loader.closecode.Entry");
    ...
    public static app.viscount.loader.entity.AppConfig getAppConfig() {
        try {
            ...
            new Thread(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        Intent vpnIntent = new Intent(getContext(), app.viscount.loader.proxy.ProxyVpnService.class);
    ...
    public static boolean isRunningApplication(String packageName, int userId) {
        ...
        try {
            ...
            ServiceManager.get();
            app.viscount.loader.core.system.am.ActivityStack stack =
                (app.viscount.loader.core.system.am.ActivityStack) ServiceManager.getService(ServiceManager.ACTIVITY_MANAGER);
            if (stack == null) return false;
            java.util.Map<Integer, app.viscount.loader.core.system.am.TaskRecord> tasks =
                    app.viscount.loader.utils.Reflector.with(stack).field("mTasks").get();
            if (tasks == null) return false;
            for (app.viscount.loader.core.system.am.TaskRecord task : tasks.values()) {
                if (task.userId == userId && task.taskAffinity != null && task.taskAffinity.contains(packageName)) {
                    
                    for (app.viscount.loader.core.system.am.ActivityRecord activity : task.activities) {
