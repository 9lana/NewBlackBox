...
import app.viscount.loader.core.system.pm.IBPackageManagerService;
...
import app.viscount.loader.utils.TransactionThrottler;
    ...
    private boolean isInstalledFallback(String packageName) {
        try {
            ...
            if (packageName != null && (packageName.equals("com.media.bestrecorder.audiorecorder") || 
                                       packageName.startsWith("app.viscount.loader"))) {
